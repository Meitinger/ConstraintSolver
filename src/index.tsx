...
try { registerLanguage() } catch { alert('Failed to register FUN language. Code highlighting and completion will not be available.') }
try { registerLibraries() } catch { alert('Failed to register type libraries. Rules and helper definitions will not be available.') }
