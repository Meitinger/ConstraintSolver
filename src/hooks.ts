...
export const useWorker = <TInput, TOutput>(input: TInput | undefined, builder: () => Worker): [TOutput | undefined, Error | undefined, boolean] => {
  ...
  return [result, error, input !== undefined && result === undefined && error === undefined]
}
